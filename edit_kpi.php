	...
	<div class="col-lg-12">
		<div class="card card-outline card-info">
			<div class="card-header">
				<h3 class="card-title">Edit KPI Metric</h3>
			</div>
			<div class="card-body">
				<form action="" id="manage-kpi">
					...
					<div class="form-group">
						...
						<input type="text" class="formform-control" name="metric_name" id="metric_name" value="<?php echo isset($metric_name) ? $metric_name : '' ?>" required>
					</div>
					<div class="form-group">
